...
function resetJobState()
    ...
    if (postalJobState.goPostalVan) then
        ...
        print('^6[^3Corey-PostalJob^6]^0 Unsupported Target detected!')
        end
    end
...
function startPostalJob()
    ...
    TriggerServerEvent("Corey-PostalJob:server:start:job")
    ...
    postalJobState.postalBoxZone = TARGET.AddBoxZone('Corey-PostalJob-grab-delivery', deliveryCoords, vec3(1.0, 1.0, 3.0), parameters)
...
function spawnGoPostalVehicle()
    ...
    SetVehicleMod(vehicle, 0, 1, false) -- Spoiler 3
...
function endPostalJob()
    ...
    TriggerServerEvent("Corey-PostalJob:server:end:job")
...
function deliverPackageToPed()
    ...
    TriggerServerEvent('Corey-PostalJob:server:compensateDelivery', postalJobState.positionSet)
